...
<fmt:message key="top.audiobooks" var="audiobook"/>
...
<table style="margin:0;padding-top:5px">
    <tr>
        ...
        <td style="min-width:4em;padding-right:1em;text-align: center">
            <a href="audiobooks.view?" target="main"><img src="<spring:theme code="nowPlayingImage"/>" title="${audiobook}" alt="${audiobook}"></a>
            <div class="topHeader"><a href="audiobooks.view?" target="main">${audiobook}</a></div>
        </td>
